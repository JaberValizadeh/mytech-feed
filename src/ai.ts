...
const CATEGORY_GUIDE = `راهنمای دسته‌ها: ai=هوش مصنوعی و یادگیری ماشین، robotics=رباتیک، ربات‌ها، اتوماسیون، بازوهای رباتیک، ربات‌های انسان‌نما و خودران، startups=استارتاپ و سرمایه‌گذاری، hardware=سخت‌افزار و گجت، software=نرم‌افزار و توسعه، security=امنیت و حریم خصوصی، science=علم و پژوهش، business=کسب‌وکار فناوری، policy=سیاست‌گذاری و قانون، general=عمومی. اگر خبر درباره ربات یا رباتیک است، دسته robotics را انتخاب کن.`;
