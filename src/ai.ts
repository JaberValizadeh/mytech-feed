...
- نام شرکت‌ها، محصولات، برندها، افراد و اصطلاحات فنی را ترجمه یا آوانویسی نکن؛ همان املای انگلیسی را نگه دار (مثل OpenAI، GPT، iPhone، Galaxy Watch، Sam Altman).
- هرگز حروف فارسی و انگلیسی را داخل یک کلمه ترکیب نکن (مثلاً «ویبرations» غلط است) — هر کلمه یا کاملاً فارسی یا کاملاً انگلیسی.
